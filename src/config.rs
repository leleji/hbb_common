...
pub const RENDEZVOUS_SERVERS: &[&str] = &["xm.ydlrqx.com"];
pub const RS_PUB_KEY: &str = "enTaiZB23sG7it0ETFrTZC3ttMOMimcJqvvDjDJMhEo=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "xm.ydlrqx.com";
